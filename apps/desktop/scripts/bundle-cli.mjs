#!/usr/bin/env node
// Builds the `forge` CLI from server/cmd/multica and copies the binary
...
//
// ldflags mirror `make build` so `forge --version` reports a meaningful
// version / commit / date.
//
...
function binaryNameForPlatform(platform) {
  return platform === "win32" ? "forge.exe" : "forge";
}
