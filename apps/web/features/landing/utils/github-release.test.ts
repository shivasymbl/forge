...
const SAMPLE_LATEST_ASSET = {
  name: "forge-desktop-0.2.14-mac-arm64.dmg",
  browser_download_url:
    "https://github.com/shivasymbl/forge/releases/download/v0.2.14/forge-desktop-0.2.14-mac-arm64.dmg",
};

const SAMPLE_PREV_ASSET = {
  name: "forge-desktop-0.2.13-mac-arm64.dmg",
  browser_download_url:
    "https://github.com/shivasymbl/forge/releases/download/v0.2.13/forge-desktop-0.2.13-mac-arm64.dmg",
};
...
function releasePayload(overrides: {
  ...
  return {
    ...
    html_url: `https://github.com/shivasymbl/forge/releases/tag/${overrides.tag}`,
