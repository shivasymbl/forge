...
var rootHelpTemplate = `Work seamlessly with Forge from the command line.
...
EXAMPLES
  $ forge login
  $ forge issue list --output json
  $ forge daemon start
  $ forge agent list --output json
...
LEARN MORE
  Use ` + "`forge <command> <subcommand> --help`" + ` for more information about a command.
`
