...
// other API call is what surfaces a user-actionable "run forge login"
...
func (d *Daemon) runTask(ctx context.Context, task Task, provider string, slot int, taskLog *slog.Logger) (TaskResult, error) {
	...
	// can call the Multica API and the local daemon (e.g. `forge repo checkout`).
	...
	// `forge issue status` / `forge issue comment add`, leaving issues
	// stuck in `todo`.
	//
