...
// subagents. The Forge daemon currently models only the parent Codex
...
// lifecycle state with drain/cancel primitives, or the Forge runtime
...
//
// Users who explicitly want Codex native subagents inside a Forge task
...
const (
	multicaMultiAgentBeginMarker = "# BEGIN forge-managed multi-agent (do not edit; regenerated by daemon)"
	multicaMultiAgentEndMarker   = "# END forge-managed multi-agent"
)
