...
- `server/cmd/forge/cmd_project.go` registers project `list`, `get`, `create`, `update`, `delete`, and `status`.
...
- Project resources are written into `.forge/project/resources.json` for agent workdirs.
